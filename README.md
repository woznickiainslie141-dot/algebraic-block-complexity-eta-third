...
The manuscript PDF and LaTeX source for that version are also archived as a [Zenodo AI-generated research draft](https://doi.org/10.5281/zenodo.22961670) (version DOI: `10.5281/zenodo.22961670`). Zenodo requires a Creator entry for citation; its record lists Cheng Huang with the role **Distributor** to identify who shares and maintains this draft. The manuscript itself retains an empty author field and does not attribute the mathematical argument to a human author.
